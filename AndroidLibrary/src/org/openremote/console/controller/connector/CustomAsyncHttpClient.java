...
/**
 * This is a custom implementation of the Loopj AsyncHttpClient to add capability
 * for controller discovery (this re-uses the existing Loopj infrastructure).
 * 
...
class CustomAsyncHttpClient extends AsyncHttpClient {
   ...
   * @return
   */
  public void startDiscovery(int tcpPort, Integer discoveryDuration, ResponseHandlerInterface responseHandler) {
